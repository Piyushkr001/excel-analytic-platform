...
export default function AboutUs() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-green-50 via-white to-sky-50 px-6 py-16">
      {/* Header */}
      <header className="max-w-5xl mx-auto text-center mb-20 animate-fadeIn">
        ...
        <p className="mt-5 text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
          Empowering individuals and organizations with smart Excel analytics. Visualize, interpret,
          and share your data effortlessly.
        </p>
      </header>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center max-w-7xl mx-auto gap-12 animate-fadeIn">
        ...
        <div className="flex-1 space-y-6">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            At <strong>Xcellytics</strong>, our mission is to simplify data visualization for
            everyone. Whether you’re a student, a data analyst, or a business professional, our
            tools make working with spreadsheets easier and more powerful.
          </p>
          <p className="text-gray-700">
            We focus on clean UI, seamless integration, and real-time analytics to ensure your data
            speaks volumes without technical friction.
          </p>
          <p className="text-gray-700">
        ...
        <div className="flex-1">
          <img
            ...
            alt="Illustration representing the Xcellytics team"
      ...
      {/* Team Section */}
      <section className="max-w-7xl mx-auto mt-24 animate-fadeIn">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Meet the Team</h2>
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
          {teamMembers.map(({ name, role, img, email }) => (
            <div
              key={name}
            ...
            >
              ...
              <a
                href={`mailto:${email}`}
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl text-sm transition"
      ...
      <div className="text-center mt-24">
        ...
        <a
          href="/register"
          className="inline-block mt-4 px-6 py-3 bg-gradient-to-r from-emerald-500 to-indigo-600 text-white font-semibold rounded-2xl shadow hover:opacity-90 transition"
        >
          Get Started
        </a>
      </div>
